...
var pages = ['index', 'redifi', 'photography', 'aerial-photography', 'software-development', 'contact'];
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).keydown(function (e) {
  var gotoPage = null;

  if (e.which === 37 || e.which === 39) {
    var url = window.location.pathname;
    var currentPage = url.substring(url.lastIndexOf('/') + 1).replace(/\.[^/.]+$/, "") || 'index';
    var currentPageIndex = pages.findIndex(function (page) {
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].Move = foundation_sites_js_foundation_util_motion__WEBPACK_IMPORTED_MODULE_7__["Move"]; // Foundation.Nest = Nest;
// Foundation.Timer = Timer;
// Touch and Triggers previously were almost purely sede effect driven,
// so no need to add it to Foundation, just init them.

foundation_sites_js_foundation_util_touch__WEBPACK_IMPORTED_MODULE_8__["Touch"].init(jquery__WEBPACK_IMPORTED_MODULE_0___default.a);
foundation_sites_js_foundation_util_triggers__WEBPACK_IMPORTED_MODULE_9__["Triggers"].init(jquery__WEBPACK_IMPORTED_MODULE_0___default.a, foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"]);
...
module.exports = __webpack_require__(/*! /Users/janklan/dev/tacticmedia.com.au/src/assets/js/app.js */"./src/assets/js/app.js");
